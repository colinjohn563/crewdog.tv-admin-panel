...
import 'package:crewdogadmin/screens/approved_jobs.dart';
import 'package:crewdogadmin/screens/disapproved_jobs.dart';
          ...
          bottom: const TabBar(
            ...
            tabs: [
              Tab(
                  ...
                  text: "Pending Review Jobs"),
              Tab(icon: Icon(Icons.check_box), text: "Approved Jobs"),
              Tab(
                  icon: Icon(Icons.disabled_by_default),
                  text: "Disapproved Jobs")
            ],
          ),
        ),
